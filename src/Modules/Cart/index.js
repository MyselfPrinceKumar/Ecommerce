...
const Cart = () => {
    ...
    if (carts.length===0) {
        ...
        return <div className='mt-10 text-2xl font-semibold text-gray-600 text-center items-center justify-center'>Cart is Empty</div>
    }
                                ...
                                <div className="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5">
                                    <div className="flex w-2/5">
                                        ...
                                        <div className="flex flex-col justify-between ml-4 flex-grow">
                                            ...
                                            <span className="text-green-600 hover:text-green-800 text-xs capitalize">{cart?.category}</span>
